/*
  # Update get_elderly_profile_full_details Function for Current Schema

  ## Changes
  - Update medications query to use current schema fields:
    - `dosage_quantity` (integer) instead of `dosage` (text)
    - `times_of_day` (text[]) instead of `frequency` and `time`
  - Ensures function works with the updated medications table structure

  ## Impact
  - Fixes the function to return correct medication data
  - Enables webhook payload to include accurate medication information
*/
